<x-modal :id="$id??'common_popup_modal'" :class="$class??''" :extra="['cls'=>'bg-primary-dark']">
    ...
    <x-slot name="modal_content">
        ...
        <div class="block-content block-content-full text-right border-top">
            ...
            <button type="button" class="checkin-btn btn btn-primary"  onclick="ajaxCallOnclick('confirm/delete/project',{project_id:{{$project_id??''}},containerId:'{{"$id"??'common_popup_modal'}}'})"
            >Delete</button>
