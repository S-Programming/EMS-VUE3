            ...
            @foreach($projects as $project)
                <tr>
                    ...
                    @if(isset($project->project_status) && $project->project_status===0)
                        <td class="font-w600 font-size-sm text-nowrap"><button type="button" class="btn btn-secondary" disabled> Project Assigned </button></td>
                    ...
                    @elseif($project->project_status===5)
                        <td class="font-w600 font-size-sm"><button type="button" class="btn btn-success" disabled> Completed </button></td>
                    @endif
                    <td>
