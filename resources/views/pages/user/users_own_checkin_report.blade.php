        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
                <div class="row items-push">
                    <div class="col-lg-8">
                        <form action="{{ route('checkin.history.bt.dates') }}" method="POST"
                              id="filter-form-id-bt-dates">
                            @csrf
                            <div class="form-group row">
                                <div class="col-5">
                                    ...
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text"
                                               ...
                                               name="start_date" data-date-format="mm-dd-yyyy"
                                ...
                                <div class="col-5">
                                    ...
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text"
                                               class="form-control form-control-alt form-control-lg"
                                               name="end_date" data-date-format="mm-dd-yyyy"
                                               data-autoclose="true" readonly>
                                        <div class="input-group-addon">
                                            <span class="glyphicon glyphicon-th"></span>
                                        </div>
                                ...
                                <div class="col-2">
                                    <label>&nbsp;</label>
                                    <button type="submit" class="btn btn-dark btn-sm form-control"
                                            onclick="validateFieldsByFormId(this)"
                                            data-validation="validation-span-id"
                                            id="validation-span-id">Search
                                    </button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="block-content bg-body-light">
                    <div id="one-dashboard-search-orders"
                         class="block-content border-bottom d-none">
                        <!-- Search Form -->
