    ...
    <x-slot name="modal_content">
        <div class="block-content font-size-sm">
            <form method="POST" action="{{ route('report.edit') }}" id="report-form-id" data-modal-id="{{$id??'common_popup_modal'}}">
                ...
                <x-input id="checkin_id" class="form-control form-control-alt form-control-lg" type="hidden" name="user_task_log_id" value="{{$user_task_log_id??''}}" required autofocus />
                ...
                <div class="py-3">
                    ...
                    <textarea id="task_details" class="tinymce-editor-cls tinymce-modal form-control form-control-alt form-control-lg" name="task_details" required autofocus>{{$description}}</textarea>
                </div>
