    ...
    <x-slot name="modal_content">
        <div class="row">
            <div class="col-sm-10 offset-1">
                <form method="POST" action="{{ route('leave.type.confirm.add') }}" id="login-form-id" data-modal-id="{{$id??'common_popup_modal'}}">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="py-2">
                                <div class="form-group">
                                    ...
                                    <x-input id="type" class="form-control form-control-alt form-control-lg" type="text" name="type" required autofocus />
                                </div>
                            </div>
                        </div>
                    </div>
