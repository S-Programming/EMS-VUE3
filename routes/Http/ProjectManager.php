...
class ProjectManager
{
    static function register()
    {
        Route::group(['middleware' => ['auth:sanctum']], function () {
            ...
            Route::post('/user/pending/projects', [ProjectManagerController::class, 'userPendingProjectsList'])->name('project.manager.pending.projects');
            ...
            Route::post('/completed/projects', [ProjectManagerController::class, 'CompletedProjectsList'])->name('project.manager.completed.projects');
