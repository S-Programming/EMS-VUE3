...
//            Route::get('/feedback', [FeedbackController::class, 'index'])->name('feedback.index');
            ...
            Route::get('/view_feedback', [FeedbackController::class,'viewAdminFeedback'])->name('feedback.view');
            ...
            Route::post('/delete_feedback_modal', [FeedbackController::class,'deleteFeedbackModal'])->name('comment.delete.feedback');
            Route::post('/confirm_delete_feedback', [FeedbackController::class,'confirmDeleteFeedback'])->name('comment.delete.feedback');
