...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $menus = [
            ...
            ['id' => 17, 'name' => 'Add FeedBack', 'parent_id' => 0, 'route' => 'feedback', 'sort_order' => 0, 'class' => 'nav-main-link-name', 'icon' => 'fa fa-user', 'is_count' => 0, 'is_active' => 1],
            ['id' => 18, 'name' => 'View FeedBack', 'parent_id' => 0, 'route' => 'feedback.view', 'sort_order' => 0, 'class' => 'nav-main-link-name', 'icon' => 'fa fa-user', 'is_count' => 0, 'is_active' => 1],
            ['id' => 19, 'name' => 'Comments', 'parent_id' => 0, 'route' => 'feedback.comments', 'sort_order' => 0, 'class' => 'nav-main-link-name', 'icon' => 'fa fa-user', 'is_count' => 0, 'is_active' => 1],
