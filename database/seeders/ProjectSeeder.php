...
class ProjectSeeder extends Seeder
{
    ...
    {
        $projects = [
            ['name' => 'Login','description'=>'Login Project','start_date' => Carbon::now()->format('Y-m-d H:i:s'),'estimate_time' => '2', 'project_manager_id'=>10,'number_of_developers'=>4, 'pm_description'=>'This is pm description.','project_status'=>0,'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
            ['name' => 'Checkout','description'=>'Checkout Project','start_date' => Carbon::now()->format('Y-m-d H:i:s'),'estimate_time' => '3', 'project_manager_id'=>11,'number_of_developers'=>5,'pm_description'=>'This is pm description.','project_status'=>0,'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
