...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $users = [
            ...
            ['id' => 22, 'first_name' => 'Mudassar', 'last_name' => 'Hussain', 'email' => 'mudassar.kodestudio@gmail.com', 'phone_number' => '+923214814456', 'password' => bcrypt('12345678'), 'is_active' => 1, 'is_approved' => 1, 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
